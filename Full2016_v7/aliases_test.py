...
aliases['D_00_LL'] = {
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/public/CMSSW_10_6_10/src/PlotsConfigurations/Configurations/WW/Full2016_v7/WW_helicity/DNN/evaluate_nu_test.cc+'],
    'class': 'evaluate_cos_theta_test',
    'args': 7,
}
