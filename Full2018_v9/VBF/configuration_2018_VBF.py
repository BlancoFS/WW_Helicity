...
aliasesFile = 'Full2018_v9/aliases_VBF.py'

# file with list of variables                                                                                                                                                                              
variablesFile = 'Full2018_v9/variables_VBF.py'

# file with list of cuts                                                                                                                                                                                   
cutsFile = 'Full2018_v9/cuts_VBF.py'

# file with list of samples                                                                                                                                                                                
samplesFile = 'Full2018_v9/samples_VBF.py'

# file with plot configuration                                                                                                                                                                             
plotFile = 'Full2018_v9/plot_VBF.py'
