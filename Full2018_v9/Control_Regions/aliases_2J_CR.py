...
mes = ['RecoLevel_me_VBF_hsm', 'RecoLevel_me_QCD_hsm']
...
aliases['BDTG4D3_VBF'] = {
    'linesToAdd': ['gSystem->Load("%s/src/JHUGenMELA/MELA/data/%s/libmcfm_707.so","", kTRUE);'%(os.getenv('CMSSW_BASE'), os.getenv('SCRAM_ARCH')),
                   'gSystem->Load("libJHUGenMELAMELA.so","", kTRUE);',
                   'gSystem->Load("/afs/cern.ch/work/s/sblancof/private/CMSSW_10_6_4/lib/libmomemta.so","", kTRUE);',
                   '.L /afs/cern.ch/work/s/sblancof/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/WW/UL/VBF_DNN/TMVA_BDT_HWW.cc+' ],
    'class': 'TMVA_HWW',
    'args': 'BDTG4D3'
}
